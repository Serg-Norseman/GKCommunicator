...
namespace GKNet
{
    ...
    {
        private static readonly ILogger fLogger = LogManager.GetLogger(ProtocolHelper.LOG_FILE, ProtocolHelper.LOG_LEVEL, "MailHelper");
        ...
        public static void SendMail(string address, string subject, string body)
        {
            try {
                ...
                fLogger.WriteError("SendMail()", ex);
            }
        }
    }
    ...
    /// </summary>
    internal class MapiMailMessage
    {
    ...
    /// </summary>
    internal class RecipientCollection : CollectionBase
    {
        /// <summary>
