...
using BSLib.TeamsNet.STUN;
using BSLib.TeamsNet.TCP;
...
namespace BSLib.TeamsNet
{
    ...
    {
        public const string APP_NAME = "BSLib.TeamsNet";
        public const string APP_DESC = "Serverless peer-to-peer network library.";
        public const string APP_COPYRIGHT = "Copyright © 2018-2025 by Sergey V. Zhdanovskih";
        public const string APP_VERSION = "0.31.0.0";

        private static readonly DHTId TNInfoHash = ProtocolHelper.CreateSignInfoKey();
        ...
        private void InitializePeers()
        {
            ...
            fLocalPeer.Presence = PresenceStatus.Unknown;
        }
