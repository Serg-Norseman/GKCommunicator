...
namespace GKNet.DHT
{
    ...
    public class DHTHelperTests
    {
        ...
        public void Test_GetNeighbor()
        {
            ...
            Assert.AreEqual("1111111111111111111177777777777777777777", result.ToHex());
        }
        ...
        public void Test_ComputeRouteDistance()
        {
            ...
            Assert.AreEqual("6666666666666666666666666666666666666666", result1.ToHex());
            ...
            Assert.AreEqual("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB", result2.ToHex());
