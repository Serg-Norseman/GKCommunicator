...
namespace BSLib.TeamsNet.UI
{
    public class MessagesList : Scrollable
    {
        private sealed class MessageFrame : Drawable
        {
            ...
            public MessageFrame(BSLib.TeamsNet.Message msg, MessagesList owner)
            {
                Message = msg;
                fOwner = owner;
        ...
        public void AddMessage(BSLib.TeamsNet.Message msg, bool scrollToBottom)
        {
        ...
        protected string GetMessageItem(BSLib.TeamsNet.Message msg)
        {
